import { Button, Heading, Text, Toast, useToast } from "@chakra-ui/react";
...
export const Cart = () => {
  ...
  const handelCheckout = () => {
    if (cart.length == 0) {
      toast({
        title: "Warning!!",
        description: "You don't have any product in cart.",
        status: "warning",
        position: "top",
        duration: 4000,
        isClosable: true,
    ...
    <Div>
      <div className="cartpage">
        <div className="dummyimagediv">
          <img
            src="https://www.sundrenchd.com/cdn/shop/files/6B400614-B101-4890-A60C-2F4ADB2EF088.jpg?v=1669686695&width=1500"
            alt=""
          />
        </div>
        <div className="productsContainer">
          ...
          {cart.length == 0 ? (
            ...
            >
              <Heading style={{ fontWeight: "bolder", padding: "2rem" }}>
                Please add some items to cart.
              </Heading>
              <Link to={"/product"}>
                <Button style={{ border: "none" }} colorScheme="yellow">
                  Checkout Products
                </Button>
              </Link>
            </div>
              ...
              return (
                <div className="card">
                  ...
                  <div style={{ display: "flex", alignItems: "center" }}>
                    <button id="inc" onClick={() => handelInc(el)}>
                      +
                    </button>
                    <p style={{ margin: "10px" }}>{el.quantity}</p>
                    <button id="dec" onClick={() => handelDec(el)}>
                      -
                    </button>
                  </div>
                  <div>
            ...
            <div className="totalcalculation">
              ...
              <div className="calculation">
                ...
                <button
                  ...
                  id={cart.length == 0 ? "checkout" : "active"}
