      ...
      <Box m="30px">
          ...
          >
            ...
            >
              ...
              <Box mt="50px" lineHeight={"60px"} fontWeight={"500"}>
                <Text
                  fontSize={"16px"}
                  _hover={{ textDecoration: "underline", fontSize: "18px" }}
                >
                  Rings
                </Text>
                <Text
            ...
            <Box
              ...
              className="carousal"
            >
              <Box position={"relative"} top="40px" right="40px">
                <Carousel
                  autoPlay
                  stopOnHover={true}
                  showArrows={false}
        ...
        <Box>
          ...
          >
            <Box boxShadow="rgba(149, 157, 165, 0.2) 0px 8px 24px">
              {status ? (
                <video autoPlay={true}>
                  <source
                    src="https://cdn.caratlane.com/media/catalog/product/J/R/JR07378-1RP900_16_video.mp4"
                    type="video/mp4"
                  ></source>
                </video>
              ) : (
            ...
            <Box boxShadow="rgba(149, 157, 165, 0.2) 0px 8px 24px">
              {status ? (
                <video autoPlay={true}>
                  <source
                    src="https://cdn.caratlane.com/media/catalog/product/J/L/JL04543-1RP900_16_video.mp4"
                    type="video/mp4"
                  ></source>
                </video>
              ) : (
            ...
            >
              ...
              <Box>
                <Image
                  ...
                  borderBottomRightRadius={"10px"}
                  h="300px"
                  src="https://c.ndtvimg.com/2022-09/r9saa6k_jewellery-650_625x300_26_September_22.jpg?im=Resize=(1200,757)"
                />
              </Box>
              <Box>
                <Image
                  ...
                  borderBottomRightRadius={"10px"}
                  h="300px"
                  src="https://cdn.alromaizan.com/image/upload/v1679132367/media/blog/does-rose-gold-have-the-same-value-yellow-gold-has.webp"
                />
              </Box>
              <Box>
                <Image
                  ...
                  borderBottomRightRadius={"10px"}
                  h="300px"
                  src="https://i.pinimg.com/originals/af/e8/f3/afe8f3f60016480b8ac706bbeda9d328.jpg"
                />
              </Box>
            </Grid>
          </Box>
          ...
          >
            ...
            >
              <Box border={"2px solid gold"} w="48%">
                <Image
                  w="100%"
                  position={"relative"}
                  bottom="30px"
                  left="30px"
                  src="https://cdn.dribbble.com/users/1139443/screenshots/9733561/media/50fbe0c2133171d5bd05b6cbe5550d5c.png?compress=1&resize=800x600&vertical=center"
                />
              </Box>
              ...
              <Box mt="90px" w="48%" p="30px">
                ...
                >
                  ...
                  <br /> of branded jewellery and accessories
                </Text>
                <Box
                  mt="50px"
                  display={{
                ...
                >
                  <Text>
                    Gem Garden presents leading global brands of jewellery{" "}
                    <br /> known for their unique style and high quality
                    <br /> craftsmanship
                  </Text>
                </Box>
              </Box>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Gem Garden is More than just Gliding
                </Text>
                <Box
                  mt="20px"
                  w="48%"
                ...
                >
                  <Box mt="20px">
                    <Text>
                      Gem Garden presents leading global brands of jewellery
                      known for their unique style and high quality
                      craftsmanship
                    </Text>
                  </Box>
                  <Box mt="30px">
                    <Text>
                      We are constantly expanding our range to meet the needs of
                      our customers and offer them the latest and most
                      fashionable trends in jwelery.We are confident that our
                      collection of jwellery will allow everyone to express
                      their individual style and create a unique image.
                    </Text>
                  </Box>
                </Box>
              </Box>
              <Box border={"2px solid gold"} w="48%">
                <Image
                  ...
                  bottom="30px"
                  left="30px"
                  src="https://cdn.dribbble.com/users/1139443/screenshots/9733561/media/344679801359045f3af002ff69429749.png?compress=1&resize=800x600&vertical=center"
                />
              </Box>
            </Flex>
          </Box>
          ...
          <Box w="100%" m="40px auto">
            <Image w="100%" src={giftImg} alt="giftImg" />
          </Box>
        </Box>
      </Box>
    </>
